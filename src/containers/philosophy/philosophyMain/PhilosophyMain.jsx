...
function PhilosophyMain() {
  return (
    <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
      <div className="gpt3__whatgpt3-heading__phil">
        <h1 className="gradient__text">
          This is Decrypted Legal &amp; Consulting (Decrypted for short).
        </h1>
      </div>
      <div className="gpt3__whatgpt3-feature__phil">
        <p>
          ...
          consultation or project. <br /><br />We designed Decrypted differently. Decrypted
          ...
          popular and standard services. <br /><br />We also use the same tools as you --
          ...
          risks are worth taking and which aren’t. <br /><br />We’re here to be your
