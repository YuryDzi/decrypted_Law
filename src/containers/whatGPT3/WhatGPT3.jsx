...
const WhatGPT3 = () => (
  <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
    ...
    <div className="gpt3__whatgpt3-container">
      ...
      <Feature title="Fixed Fees" text="Guaranteed prices for your specific projects and deliverables." />
      <Feature title="Bundles" text="Reduced prices for sets of popular and essential legal services." />
    </div>
  </div>
);
